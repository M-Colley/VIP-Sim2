...
namespace VipSim.EditorTools
{
    ...
    /// takes over from, and wires it to the same camera.
    ///
    /// It attaches to AlignBoxColliderWithCamera, not FitPlaneToCameraView: the
    /// latter has zero references in any scene or prefab, so the first version of
    /// this setup aimed at dead code and failed to find anything.
    /// </summary>
